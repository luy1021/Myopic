...
D=8;
L=30;
f=@(x)(-((x(1)/b1)*(a1+r1*log(D1)-log(x(1))+log(1-x(1)-x(2)-x(3)-x(4)))...
    +(x(2)/b2)*(a2+r2*log(D2)-log(x(2))+log(1-x(1)-x(2)-x(3)-x(4)))...
    +(x(3)/b3)*(a3+r3*log(D3)-log(x(3))+log(1-x(1)-x(2)-x(3)-x(4)))...
    +(x(4)/b4)*(a4+r4*log(D4)-log(x(4))+log(1-x(1)-x(2)-x(3)-x(4)))));
...
gap2=1+(theta/((1-theta)*(1-theta^T)))*(1/fval1)*D^2*(r1*C1/(b1*D1)+r2*C2/(b2*D2)+r4*C4/(b4*D4)+r3*C3/(b3*D3))
